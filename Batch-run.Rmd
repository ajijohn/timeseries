...
for (file in filesins)
{
   ...
   oneset_9yrs_by_month$nxaxis <- as.double(paste(oneset_9yrs_by_month$year,oneset_9yrs_by_month$xaxisred,sep =     '.'))
    ...
    oneset.d.reg
    print(oneset.d.reg.3$coefficients)
    #plot it
...
plot(combineddf$`AX15-A2`)
lines(combineddf$`AX15-A2`,col='red')
lines(combineddf$`AO03-A2`,col='green')
lines(combineddf$`AM16-A2`,col='blue')
lines(combineddf$`AM16-A1`,col='yellow')
lines(combineddf$`AE10-A1`,col='purple')
lines(combineddf$`AB08-A2`,col='pink')
