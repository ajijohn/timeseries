...
#"AX15-A2_hourly.csv  - total outside   2"
#"AO03-A2_hourly.csv  - total outside   7"
#"AM16-A2_hourly.csv  - total outside   3
#"AM16-A1_hourly.csv  - total outside   3"
#"AE10-A1_hourly.csv  - total outside   2"
#"AB08-A2_hourly.csv  - total outside   4"
...
for (file in files)
{
   ...
   oneset_9yrs_by_month$nxaxis <- as.double(paste(oneset_9yrs_by_month$year,oneset_9yrs_by_month$xaxisred,sep =     '.'))
    ...
    #acf 
    acfs <- acf(resid(oneset.d.reg),lag.max = 40)$acf
