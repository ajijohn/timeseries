...
co2.years <- seq(1958,2017-1/12,1/12)

m.hat <- filter.with.padding(co2,c(1/24,rep(1/12,11),1/24))

plot(co2.years,co2,col="blue",xlab="year",typ="b",ylab=expression(paste(x[t]," and ", hat(m)[t]," (thousands)")),main="Monthly Counts of Accidental Deaths in USA",cex=0.5)
lines(co2.years,m.hat,col="red",lwd=2)
